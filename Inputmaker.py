...
for xi in np.arange(0.2,1.2,0.2):
    ...
    for temp in np.arange(300,900,100):
        for dt0 in np.arange(10,20,10):
            ...
            file = open(f"in.{xi}.{temp}.{dt0}.mxe_mt", "w")
            ...
            file.write(f"region	doped block -{xx} {xx} -0.5 0.5 -{zz} {zz}\n")
            file.write(f"\n")
            ...
            file.write(f"\n")
            file.write(f"restart 10000 restart.{xi}.{temp}.{dt0}.*\n")
            file.write(f"\n")
            ...
            file.write(f"\n")
            file.write(f"fix diff all mass_transport/atom nu 10 Qm 0.6 dt 1.0e1 rdcut 3.0 substitutional 1 xmin 0.0 xmax 1.0 rescale 1\n")
